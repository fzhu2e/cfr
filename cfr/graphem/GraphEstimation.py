...
def graph_greedy_search(field_inst, proxy_inst, target_FF, target_FP, target_PP, N=30, maxit=500):
	'''
	Greedy approach to estimate the conditional independence struture of the field using the graphical lasso. 
	Attemps to find a graph with a given target sparsity in the FF, FP, and PP parts of the adjacency matrix. 
