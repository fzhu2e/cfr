...
- Test the functionality within a self-contained Jupyter notebook. If the functionality is related to the reconstruction method, **it is required to conduct a pseudoproxy experiment (PPE)** using the [pseudoPAGES2k dataset](https://www.nature.com/articles/s41597-023-02489-1) so that the result is comparable to existing ones. For examples, please refer to [PPE: A PDA-based Reconstruction](https://fzhu2e.github.io/cfr/notebooks/pp2k-ppe-pda.html) and [PPE: A GraphEM-based Reconstruction](https://fzhu2e.github.io/cfr/notebooks/pp2k-ppe-graphem.html).
```
